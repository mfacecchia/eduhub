...
public class LessonService {
    ...
    public List<LessonDto> getAllUpcomingLessonsByAccountIdAndClassId(long accountId, long classId)
            throws AppException {
        try (Connection conn = databaseConnection.getConnection()) {
            return lessonDao.getAllUpcomingByAccountIdAndClassId(accountId, classId, conn);
        } catch (SQLException e) {
            throw new DataFetchException("Could not fetch data", e);
        }
    }
